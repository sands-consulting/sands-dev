...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        @else
        <form action="{{ url('/[[route_path]]/save/' . $model['id']) }}" method="POST" class="form-horizontal">
        @endif
            {{ csrf_field() }}

[[foreach:columns]][[if:i.type=='text']]
